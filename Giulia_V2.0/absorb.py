...
class AbsorbWindow(QMainWindow,Ui_Absorb):
    ...
    def __init__(self,parent=None):
        ...
        self.headerCN = ['代码', '名称','最新价', '涨幅', 'BBD(万)', 'DDX1日', 'DDY1日', 'DDZ', 'DDX3日', 'DDX5日', 'DDX10日', 'DDY3日', 'DDY5日','DDY10日', '通吃率1日', '通吃率5日', '通吃率10日','单数比', '特大差', '大单差', '中单差', '小单差', '主动率1日', '主动率5日', '主动率10日',  'DDX5红', 'DDX10红', 'DDX连红', 'DDX连增', '涨幅3日', '涨幅5日', '涨幅10日', '换手率', '量比','成交量(万)', '流通盘(万股)', '小单买入']
        self.setupUi(self)
