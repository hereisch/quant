...
def jetton():
    ...
    url = 'https://ai.iwencai.com/urp/v7/landing/getDataList?hexin-v=A8i-dcKBPC1Op1Cpyici-sPDmT3ZcSqNDskBGIJjFSc2FmZrKoH8C17l0MbR'
    for j in tqdm(range(1,500)):
        ...
        if resp.json()['answer']['components'][0]['data']['datas']:
            ...
            chip = list(set(list(j.keys())) ^ set( ['股票代码', '股票简称', '上市板块', '最新价', '最新涨跌幅', 'code', 'market_code']))
