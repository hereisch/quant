...
class Ui_DDE(object):
    def setupUi(self, MainWindow):
        ...
        self.sortDDZ = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortDDZ.setMaximumSize(QtCore.QSize(100, 50))
        self.sortDDZ.setObjectName("sortDDZ")
        self.horizontalLayout.addWidget(self.sortDDZ)
        self.sortDDY1 = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortDDY1.setMaximumSize(QtCore.QSize(100, 50))
        self.sortDDY1.setObjectName("sortDDY1")
        self.horizontalLayout.addWidget(self.sortDDY1)
        ...
        self.sortChange3 = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortChange3.setMaximumSize(QtCore.QSize(100, 50))
        self.sortChange3.setObjectName("sortChange3")
        self.horizontalLayout.addWidget(self.sortChange3)
        self.sortChange5 = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortChange5.setMaximumSize(QtCore.QSize(100, 50))
        self.sortChange5.setObjectName("sortChange5")
        self.horizontalLayout.addWidget(self.sortChange5)
        self.sortChange10 = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortChange10.setMaximumSize(QtCore.QSize(100, 50))
        self.sortChange10.setObjectName("sortChange10")
        self.horizontalLayout.addWidget(self.sortChange10)

        self.sortDanshu = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortDanshu.setMaximumSize(QtCore.QSize(100, 50))
        self.sortDanshu.setObjectName("sortDanshu")
        self.horizontalLayout.addWidget(self.sortDanshu)

        self.sortTeda = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortTeda.setMaximumSize(QtCore.QSize(100, 50))
        self.sortTeda.setObjectName("sortTeda")
        self.horizontalLayout.addWidget(self.sortTeda)
        self.sortZhongdan = QtWidgets.QRadioButton(self.scrollAreaWidgetContents)
        self.sortZhongdan.setMaximumSize(QtCore.QSize(100, 50))
        self.sortZhongdan.setObjectName("sortZhongdan")
        self.horizontalLayout.addWidget(self.sortZhongdan)

        self.ddxCheck = QtWidgets.QCheckBox('DDX全红')
        self.ddxCheck.setObjectName('ddxCheck')
        self.horizontalLayout.addWidget(self.ddxCheck)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sortDDZ.setText(_translate("MainWindow", "DDZ↓"))
        self.sortDDY1.setText(_translate("MainWindow", "DDY1↓"))
        ...
        self.sortDanshu.setText(_translate("MainWindow", "单数比↑"))
        self.sortTeda.setText(_translate("MainWindow", "特大↓"))
        self.sortZhongdan.setText(_translate("MainWindow", "中单↓"))
